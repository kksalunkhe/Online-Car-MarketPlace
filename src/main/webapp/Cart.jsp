...
<body>
		...
		<label class="cart">My Wish List</label>
    ...
    String sql="select sell_car.sell_id, sell_car.seller_id, sell_car.seller_name, sell_car.brand, sell_car.car_name, sell_car.reg_year, sell_car.fuel, sell_car.insurance, sell_car.kilometer, sell_car.transmission, sell_car.location, sell_car.owner, sell_car.photo_1, sell_car.photo_2, sell_car.photo_3, sell_car.photo_4, sell_car.photo_5, sell_car.photo_6, sell_car.rcbook, sell_car.description, sell_car.price, sell_car.admin_msg, sell_car.sell_date, sell_car.seller_email, sell_car.seller_contact, sell_car.seller_city, cart.cart_id, cart.sell_id, cart.user_id from sell_car JOIN cart ON sell_car.sell_id=cart.cart_id where status ='Available';";
