...
<link rel="stylesheet" href="css/Admin_Show_Cars.css" type="text/css">
<style><%@include file="css/Admin_Show_Cars.css"%></style>
...
<body>
	...
	%>	
	<form name="Admin_Show_Cars" action="Admin_Show_Cars" method="post">
				...
				<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<label class="title1"><%=rs.getString("reg_year") %></label><br>
						</div>
						<div class="col-sm-6">
							<label class="title">Fuel type</label><br>
							<label class="title1"><%=rs.getString("fuel") %></label><br><br>
						</div>
					</div>
					...
					<div class="col-sm-6">
						...
						<label class="title1"><%=rs.getString("location") %></label>
					</div>
					<div class="col-sm-6">
						<label class="title">Kilometer</label><br>
						<label class="title1"><%=rs.getString("kilometer") %></label><br>
					</div>
				</div>
			</div>
			<div class="col-sm-3"><br><br>
				<input type="submit" class="button" value="View Details" name="submit"><br>
