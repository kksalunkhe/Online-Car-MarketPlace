...
<link rel="stylesheet" href="css/View_Specific_Car.css" type="text/css">
<style><%@include file="css/View_Specific_Car.css"%></style>
...
<body>
	...
	%>	
	<form name="View_Specific_Car" action="View_Specific_Car" method="post">
		...
		<div class="col-sm-4">
			<div class="second">
				...
				<input type="submit" value="Make Offer" class="offer" name="submit"><br>
				<div class="details">
				...
				<input type="submit" value="Pay for advance Booking" class="payment" name="submit">
