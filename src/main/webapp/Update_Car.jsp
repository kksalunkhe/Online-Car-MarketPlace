...
<link rel="stylesheet" href="css/Update_Car.css" type="text/css">
<style><%@include file="css/Update_Car.css"%></style>
...
<body>
	...
	<div class="maindiv">
			<br>
			<center><label class="main">UPDATE YOUR CAR</label></center> <br>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<input type="text" class="models" placeholder=" Name of Car" name="car_name" required>
				</div>
				<div class="col-sm-4">	
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<input type="text" class="model" placeholder="KM Driven" name="kilometer" required>
				</div>
			</div>
			...
			<div class="col-sm-4">
				...
				<div class="col-sm-4">
					<input type="text" class="model" placeholder="Price" name="price" required>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-sm-6">
							<input type="file" class="file" name="photo_1">
						</div>
						<div class="col-sm-6">
							<input type="file" class="file" name="photo_2"></div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<input type="file" class="file" name="photo_3">
							</div>
							<div class="col-sm-6">
								<input type="file" class="file" name="photo_4">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<input type="file" class="file" name="photo_5">
							</div>
							<div class="col-sm-6">
								<input type="file" class="file" name="photo_6">
							</div>
						</div>
					</div>
