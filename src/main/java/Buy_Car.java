...
/**
 * Servlet implementation class Buy_Car
 */
public class Buy_Car extends HttpServlet
{
	Connection cn=null;
	Statement st=null;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
			...
			if(event.equals("View All"))
			{
				resp.sendRedirect("View_All.jsp");
			}
			...
			if(event.equals("Search"))
			{
				...
				resp.sendRedirect("Search_Cars.jsp");
			}
