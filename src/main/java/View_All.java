...
/**
 * Servlet implementation class View_All
 */
public class View_All extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		{
			resp.sendRedirect("View_Specific_Car.jsp");
		}
		...
		if(event.equals("Advance Booking"))
		{
		...
		if(event.equals(""))
		{
			String sql = "insert into cart (sell_id,user_id) values ('"+sell_id+"','"+session.getAttribute("user_id")+"')"; 
